...
# instance fields
.field ce:Landroid/arch/lifecycle/Lifecycle$State;

.field cl:Landroid/arch/lifecycle/GenericLifecycleObserver;
...
.method constructor <init>(Landroid/arch/lifecycle/LifecycleObserver;Landroid/arch/lifecycle/Lifecycle$State;)V
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->cl:Landroid/arch/lifecycle/GenericLifecycleObserver;

    .line 348
    iput-object p2, p0, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->ce:Landroid/arch/lifecycle/Lifecycle$State;
...
.method final a(Landroid/arch/lifecycle/LifecycleOwner;Landroid/arch/lifecycle/Lifecycle$Event;)V
    ...
    .line 353
    iget-object v1, p0, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->ce:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    iput-object v1, p0, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->ce:Landroid/arch/lifecycle/Lifecycle$State;

    .line 354
    iget-object v1, p0, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->cl:Landroid/arch/lifecycle/GenericLifecycleObserver;
    ...
    .line 355
    iput-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->ce:Landroid/arch/lifecycle/Lifecycle$State;
