...
.method public static ahi(Ljava/lang/String;)[B
    .registers 3
...
.method private md5Update([BI)V
    ...
    invoke-static {v1, p1, v0, v2, v3}, Loicq/wlogin_sdk/tools/c;->md5Memcpy([B[BIII)V
    ...
    .line 273
    :cond_4e
    invoke-static {v3, p1, v1, v2, v9}, Loicq/wlogin_sdk/tools/c;->md5Memcpy([B[BIII)V
...
.method private md5Update(Ljava/io/InputStream;J)Z
    ...
    :try_end_3f
    .catch Ljava/lang/Exception; {:try_start_3c .. :try_end_3f} :catch_6d
    ...
    :try_end_5a
    .catch Ljava/lang/Exception; {:try_start_57 .. :try_end_5a} :catch_71
