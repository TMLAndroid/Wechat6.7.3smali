...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v3, "cameftOrigin"
    ...
    const-string/jumbo v6, "cameftNature"
    ...
    const-string/jumbo v4, "ZIPAI_GRADIENT_LIPNEW"

    const/4 v5, 0x2

    const-string/jumbo v6, "cameftCherry"
    ...
    const-string/jumbo v4, "ZIPAI_FAIRYTALE"

    const/4 v5, 0x3

    const-string/jumbo v6, "cameftFairytale"
    ...
    const-string/jumbo v4, "XINYE"

    const-string/jumbo v6, "cameftXinye"
    ...
    const-string/jumbo v4, "QIANGWEI"

    const-string/jumbo v6, "cameftQiangwei"
    ...
    const-string/jumbo v4, "TANGGUOMEIGUI"

    const-string/jumbo v6, "cameftTangguomeigui"
    ...
    const-string/jumbo v4, "SHUILIAN"

    const/4 v5, 0x7

    const-string/jumbo v6, "cameftShuilian"
    ...
    const-string/jumbo v4, "FENHONGBAO"

    const/16 v5, 0x8

    const-string/jumbo v6, "cameftFenhongbao"
    ...
    const-string/jumbo v4, "AMARO"

    const/16 v5, 0x9

    const-string/jumbo v6, "cameftQingyi"
    ...
    const-string/jumbo v4, "FBBS_NUANYANG"

    const/16 v5, 0xa

    const-string/jumbo v6, "cameftNuanyang"
    ...
    const-string/jumbo v4, "YOUJIALI"

    const/16 v5, 0xb

    const-string/jumbo v6, "cameftYoujiali"
    ...
    const-string/jumbo v4, "MIC_PTU_YOUJIALI"

    const-string/jumbo v6, "cameftShengdai"
    ...
    const-string/jumbo v4, "MIC_PTU_ZIPAI_LIGHTRED"

    const/16 v5, 0xd

    const-string/jumbo v6, "cameftYinghong"
    ...
    const-string/jumbo v4, "MIC_PTU_FBBS_LANGMAN"

    const/16 v5, 0xe

    const-string/jumbo v6, "cameftRomantic"
    ...
    const-string/jumbo v4, "MIC_PTU_ZIPAI_OKINAWA"

    const/16 v5, 0xf

    const-string/jumbo v6, "cameftFenbi"
    ...
    const-string/jumbo v4, "MIC_PTU_ZIPAI_TIANMEI"

    const/16 v5, 0x10

    const-string/jumbo v6, "cameftTianmei"
    ...
    const-string/jumbo v4, "MIC_PTU_FEN2"

    const/16 v5, 0x11

    const-string/jumbo v6, "cameftFennen"
    ...
    const-string/jumbo v4, "MIC_PTU_ZIPAI_LIGHTGREEN"

    const/16 v5, 0x12

    const-string/jumbo v6, "cameftTianbohe"
    ...
    const-string/jumbo v4, "MIC_PTU_ZIPAI_MAPLERED"

    const/16 v5, 0x13

    const-string/jumbo v6, "cameftMoscow"
    ...
    const-string/jumbo v4, "MIC_PTU_ZIPAI_RICHRED"

    const/16 v5, 0x14

    const-string/jumbo v6, "cameftSeoul"
    ...
    const-string/jumbo v4, "MIC_PTU_ZIPAI_OCEAN"

    const/16 v5, 0x15

    const-string/jumbo v6, "cameftOkinawa"
    ...
    const-string/jumbo v4, "MIC_PTU_ZIPAI_YOUNG"

    const/16 v5, 0x16

    const-string/jumbo v6, "cameftShowa"
    ...
    const-string/jumbo v4, "MIC_PTU_ZIPAI_TOKYO"

    const/16 v5, 0x17

    const-string/jumbo v6, "cameftTokyo"
    ...
    const-string/jumbo v4, "MIC_PTU_ZIPAI_SAPPORO"

    const/16 v5, 0x18

    const-string/jumbo v6, "cameftSapporo"
    ...
    const-string/jumbo v4, "MIC_PTU_ZIPAI_RICHBLUE"

    const/16 v5, 0x19

    const-string/jumbo v6, "cameftMediterranean"
    ...
    const-string/jumbo v4, "MIC_PTU_ZIPAI_RICHYELLOW"

    const/16 v5, 0x1a

    const-string/jumbo v6, "cameftFlorence"
    ...
    const-string/jumbo v4, "MIC_PTU_ZIPAI_TEAMILK"

    const/16 v5, 0x1b

    const-string/jumbo v6, "cameftNaicha"
    ...
    const-string/jumbo v4, "WEICO_FILM"

    const/16 v5, 0x1c

    const-string/jumbo v6, "cameftDanya"
    ...
    const-string/jumbo v4, "MIC_PTU_ZIPAI_BLACKWHITEZIPAI"

    const/16 v5, 0x1d

    const-string/jumbo v6, "cameftHeibai"
    ...
    const-string/jumbo v4, "MIC_PTU_ZIPAI_GRADIENT_GLAREFONDDREAM"

    const/16 v5, 0x1e

    const-string/jumbo v6, "cameftMenghuan"
    ...
    const-string/jumbo v4, "MIC_PTU_ZIPAI_GRADIENT_FASHION"

    const/16 v5, 0x1f

    const-string/jumbo v6, "cameftShishang"
    ...
    const-string/jumbo v4, "MIC_PTU_ZIPAI_LIGHT"

    const/16 v5, 0x20

    const-string/jumbo v6, "cameftBaicha"
    ...
    const-string/jumbo v4, "CUOJUE_2"

    const/16 v5, 0x21

    const-string/jumbo v6, "cameftCuojue2"
    ...
    const-string/jumbo v4, "DISTORTION"

    const/16 v5, 0x22

    const-string/jumbo v6, "cameftNiuqu"
